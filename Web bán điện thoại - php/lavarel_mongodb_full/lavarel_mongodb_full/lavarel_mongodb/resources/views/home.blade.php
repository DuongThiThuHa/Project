...
<!--danh muc-->
<div class = "category">
    <div class = "categoryList" style="margin-left: 145px">
...
<div style="float:left">
    <!--Tab items-->
    <div class="tabs" style="margin-left: 400px;">
...
<div style = "background-color: #EDE9E9; height: 1160px; width: 100%; float: left; margin-top: 50px">
    ...
    <div style="float: left; margin-left: 40px">
        <div class="card" style="width: 22rem; margin-left: 10px; float: left; margin-top: 30px">
    ...
    <!--BLOG-->
    <p style="text-align: center; margin-top: 500px">BLOG</p>
    <div id="carouselExampleInterval1" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="4000">
                <div class="card mb-3" style="width: 940px; margin-left: 250px; height: 300px">
                    <div class="row g-0">
                        <div class="col-md-4">
