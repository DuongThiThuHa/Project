...
<form style="width: 25%; margin-left: 500px; margin-top: 50px" action="/checkLogin" method="post">
    ...
    <div class="mb-3" style="margin-top: 50px; margin-left: 140px" >
    ...
    <div class="mb-3" style="margin-top: 30px; margin-left: 140px">
        <label for="exampleInputPassword1" class="form-label"><b>Password:</b></label>
        <input type="password" placeholder="Your password..." class="form-control" name="exampleInputPassword" required>
    </div>

    <button type="submit" class="btn btn-success" style="border: none; background-color: #43A316; width: 150px; float: left; margin-top: 25px;margin-left: 30px">Login</button>
</form>
    <button class="btn btn-success" style="background: white; color: #333333; width: 150px; margin-left: 15px; margin-top: 25px;margin-left: 140px"><a style="text-decoration: none; color: black" href="{{url('/register')}}">Register</a></button>
